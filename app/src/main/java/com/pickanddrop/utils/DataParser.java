    ...
    public List<List<HashMap<String, String>>> parse(JSONObject jObject){
        ...
        try {
            ...
            jRoutes = jObject.getJSONArray("routes");
             System.out.println("jRoutes----> "+new Gson().toJson(jRoutes));
            ...
            for(int i=0;i<jRoutes.length();i++){
                ...
                for(int j=0;j<jLegs.length();j++){
                    ...
                    routes.add(path);
                    double dist = totalDistance / (1000.0*1.609344);

                    MyConstant.DISTANCE = String.valueOf(dist);
                    ...
                    //  MyConstant.DURATION = String.valueOf(days + " days " + hours + " hours " + minutes + " mins " + seconds + " seconds "); //CHECK HERE
                    MyConstant.DURATION = String.valueOf(days + " days " + hours + " hours  "); //CHECK HERE
